...
namespace USBDevices.Classes
{
    ...
    {
        private readonly Dictionary<int, VendorInformation> _vendorInformations =
            new Dictionary<int, VendorInformation>();
        ...
        public VendorLookup()
        {
            ...
            foreach (var line in lines)
            {
                ...
                if (line.StartsWith("\t"))
                {
                    ...
                    var prodId = int.Parse(num, NumberStyles.HexNumber);
                ...
                else
                {
                    ...
                    var vendorId = int.Parse(num, NumberStyles.HexNumber);
                    lastVendorId = vendorId;
                    var vendorName = line.Substring(6).Trim();
